...
@pytest.fixture(scope='session')
def flac_application_data(flac_application_block):
...
@pytest.fixture(scope='session')
def flac_cuesheet_data(flac_cuesheet_block):
...
@pytest.fixture(scope='session')
def flac_padding_data(flac_padding_block):
...
@pytest.fixture(scope='session')
def flac_picture_data(flac_picture_block):
...
@pytest.fixture(scope='session')
def flac_seektable_data(flac_seektable_block):
...
@pytest.fixture(scope='session')
def flac_streaminfo_data(flac_streaminfo_block):
...
@pytest.fixture(scope='session')
def flac_vorbis_comment_data(flac_vorbis_comment_block):
...
@pytest.fixture(scope='session')
def id3v22_picture(id3v22_picture_frame):
	return id3v22_picture_frame[6:]


@pytest.fixture(scope='session')
def id3v22_picture_data(id3v22_picture):
...
@pytest.fixture(scope='session')
def id3v24_picture(id3v24_picture_frame):
	return id3v24_picture_frame[10:]


@pytest.fixture(scope='session')
def id3v24_picture_data(id3v24_picture):
